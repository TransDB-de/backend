...
export default class TransDBBackendServer extends Server {
	...
	private async setupControllers(): Promise<void> {
		...
		const DefaultController = (
			await import("./controllers/default.controller.js")
		).default;
		const EntriesController = (
			await import("./controllers/entries.controller.js")
		).default;
		const GeodataController = (
			await import("./controllers/geodata.controller.js")
		).default;
		const ReportController = (
			await import("./controllers/report.controller.js")
		).default;
		const AccessController = (
			await import("./controllers/access.controller.js")
		).default;
